  ...
  return (
    <main className="mx-auto w-full max-w-[1440px] border-x border-gray-200 bg-white text-gray-900">
      ...
      <section className="flex flex-col items-start gap-0 px-4 w-full border-b border-gray-200 py-8 sm:py-12 lg:py-16">
        ...
        <h1 className="mt-2 max-w-4xl text-left text-4xl font-light leading-tight tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 border-b border-gray-200">
        ...
        <div className="flex flex-col border-b md:border-b-0 md:border-r border-gray-200 p-6 lg:p-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm font-mono text-gray-400">0 1</span>
          </div>
          <div className="mb-6">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center h-11 px-7 text-sm font-medium rounded-sm border border-gray-200 bg-white text-gray-900 hover:bg-gray-50 transition-colors"
          >
            Start Free
          </Link>
        </div>
        ...
        <div className="flex flex-col border-b md:border-b-0 md:border-r border-gray-200 p-6 lg:p-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm font-mono text-gray-400">0 2</span>
          </div>
          <div className="mb-6">
            <span className="text-5xl font-light text-gray-900">$500</span>
          ...
          <Link
            href="https://trysupervisor.com/app"
            className="inline-flex items-center justify-center h-11 px-7 text-sm font-medium rounded-sm bg-gray-900 text-white hover:bg-gray-800 transition-colors"
          >
            Get Started
          </Link>
        </div>
        ...
        <div className="flex flex-col p-6 lg:p-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm font-mono text-gray-400">0 3</span>
          </div>
          <div className="mb-6">
            <span className="text-5xl font-light text-gray-900">Custom</span>
          </div>
          <p className="text-gray-600 mb-6">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 border-b border-gray-200">
        <div className="flex flex-col justify-center p-6 lg:p-12 lg:border-r border-gray-200">
          ...
          <h2 className="text-3xl sm:text-4xl font-light leading-tight text-gray-900 mb-4">
        ...
        <div className="hidden lg:block bg-gray-50 min-h-[200px]"></div>
      </section>
      ...
      <section className="p-6 lg:p-12">
        ...
        <div className="border-t border-gray-200">
          <div className="py-6 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900 mb-3">What&apos;s included in the Free plan?</h3>
